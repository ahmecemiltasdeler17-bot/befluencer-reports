...
import { SafeAvatar, SafeThumbnail } from "./safe-media";
...
export function TikTokContentCard({
  ...
  return (
    <article className="overflow-hidden rounded-[16px] border border-white/[0.08] bg-[#0C0C0E]">
      {showCreatorHeader && (
      ...
      <div className="relative aspect-[9/16] w-full overflow-hidden bg-zinc-900">
        ...
        {isAboveAverage && (
          <div className="absolute bottom-3 left-3">
            <span className="rounded-full bg-[#FF5A00]/90 px-2 py-0.5 text-[10px] font-semibold text-white">
              Yüksek Performans
            </span>
          </div>
        )}
        ...
        <div className="flex items-center justify-between gap-3">
          ...
          <div
            className={cn(
              ...
              isAboveAverage ? "text-[#FF5A00]" : "text-zinc-400"
            )}
